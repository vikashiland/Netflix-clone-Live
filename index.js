// Consts
const apikey = "b86abc8836f3612058fedcc7d3435615";
...
const apiPaths = {
    ...
    SearchOnYoutube: (query) => `https://www.googleapis.com/youtube/v3/search?part=snippet&q=${query}&key=AIzaSyB-DK7gBzEsivhQqIkHxqt8CSw35djAtyA`,
    top_ratedMovie:    `${apiEndpoint}/movie/top_rated?api_key=${apikey}`
}    


//Boots up the app
function init(){
       fetchtop10MovieSection();
       fetchTrendingMovies();
...
function fetchTrendingMovies(){
        ...
        function buildBannerSection(movie){
            ...
            <p class="banner_overview">${movie.overview && movie.overview.length > 200 ? movie.overview.slice(0,150).trim()+ '...':movie.overview}</p>
...
function fetchtop10MovieSection(){
    fetchandbuildMovieSection(apiPaths.top_ratedMovie,'Top Rated')
} 
